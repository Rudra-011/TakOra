...
- **Backend / Database:** Currently none (all tasks are stored temporarily in the browser session).  
- **Functionality:** Pure client-side dynamic web application.

---

## 💻 Installation and Setup

To run TaskOra locally:
